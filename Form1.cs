...
namespace E_squaro
{
    public partial class Form1 : Form
    {
        ...
        //--------------------------------------------------------------------------------------------------------------------------------------------------------
        private E_squaro.CellType[][] Zwroc_Tablice_CellType_3X3()
        {
            int szerokosc = 3;
        ...
        private E_squaro.CellType[][] Zwroc_Tablice_CellType_4X4()
        {
            int szerokosc = 4;
            E_squaro.CellType[][] tablica = new E_squaro.CellType[szerokosc][];
            for (int i = 0; i < szerokosc; i++)
        ...
        private E_squaro.CellType[][] Zwroc_Tablice_CellType_5X5()
        {
            int szerokosc = 5;
            E_squaro.CellType[][] tablica = new E_squaro.CellType[szerokosc][];
            for (int i = 0; i < szerokosc; i++)
